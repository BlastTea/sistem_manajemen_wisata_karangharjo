                        ...
                        <div class="hidden w-full xl:block xl:w-1/2">
                            <div class="px-26 py-17.5 text-center">
                                <span class="mt-15 inline-block">
                                    <img src="<?= $_ENV['APP_URL'] . '/storage/images/illustration/illustration-03.svg' ?>"
                                        alt="illustration" />
                                </span>
                            </div>
                        </div>
                            ...
                            <div class="w-full p-4 sm:p-12.5 xl:p-17.5">
                                ...
                                <form>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="relative">
                                            <input type="password" placeholder="6+ Characters" class="form-input" />
                                    ...
                                    <div class="mb-5">
                                        <input type="submit" value="Masuk" class="form-auth-submit" />
                                    </div>

                                    <div class="mt-6 text-center">
                                        <p class="font-medium">
                                            Masih belum memiliki akun?
                                            <a href="<?= $_ENV['APP_URL'] . '/register' ?>" class="text-primary">Register</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
