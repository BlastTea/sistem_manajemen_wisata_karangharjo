...
<head>
    ...
    <title>
        Dashboard | Rumah Pintar Karangharjo
    </title>
                ...
                <div class="header-content">
                    ...
                    <div class="flex-center gap-3 2xsm:gap-7">
                        <ul class="flex-center gap-2 2xsm:gap-4">
                            ...
                            <li class="relative" x-data="{ dropdownOpen: false, notifying: true }"
                                ...
                                <a class="notification" href="#"
                                    ...
                                    <svg class="fill-current ease-in-out-300" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                            <a class="flex-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                                <span class="hidden text-right lg:block">
                                    <span class="block text-medium text-black dark:text-white">Thomas Anree</span>
                            ...
                            <!-- Dropdown Start -->
                            <div x-show="dropdownOpen" class="dropdown-userarea">
                                <ul
                                    class="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                                    <li>
                                        <a href="profile.html" class="list-header-style">
                                    ...
                                    <li>
                                        <a href="messages.html" class="list-header-style">
                                            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <li>
                                        <a href="settings.html" class="list-header-style">
                                            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
