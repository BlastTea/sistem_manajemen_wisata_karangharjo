                ...
                <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
                    <div class="mx-auto max-w-7xl">
                        ...
                        <div x-data="{ showEditPopup: false, showDeletePopup: false, currentRow: null }"
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                    <p x-text="row.status" :class="{
                                                            'bg-green-400 bg-opacity-10 text-success': row.status === 'paid',
                                                            'bg-yellow-400 bg-opacity-10 text-warning': row.status === 'pending',
                                                            'bg-red-500 bg-opacity-10 text-red-500': row.status === 'refund'
                                                        }"
                            ...
                            <?php include __DIR__ . '\..\root_components/paketPopup.php' ?>
                        </div>
                    </div>
                </div>
            </main>
