    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
            ...
            <main>
                <p class="text-white">
                    Disini ada data ya
                    <?php echo htmlspecialchars(json_encode($data), ENT_QUOTES, 'UTF-8'); ?>
                </p>
                        ...
                        <div class="card-items">
                            ...
                            <div class="card-end">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Pengunjung Website</span>
                                </div>
                            </div>
                        </div>
                        <!-- Card Item End -->
                        ...
                        <div class="card-items">
                            ...
                            <div class="card-end">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Total Paket</span>
                                </div>
                            </div>
                        </div>
                        <!-- Card Item End -->
                        ...
                        <div class="card-items">
                            ...
                            <div class="card-end">
                                <div>
                                    ...
                                    <span class="text-sm font-medium">Total Karyawan</span>
                                </div>
                            </div>
                        </div>
                        <!-- Card Item End -->
