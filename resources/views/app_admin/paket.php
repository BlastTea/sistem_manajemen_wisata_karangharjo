                        ...
                        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <nav>
                                <ol class="flex items-center gap-2">
                                    ...
                                    <li class="font-medium text-primary">Paket Liburan</li>
                                </ol>
                            </nav>
                        </div>
                        <!-- Breadcrumb End -->

                        <?php include __DIR__ . '\..\root_components/CURD_paket.php' ?>

                        <!-- Table invoice -->
                        <?php
                        // Contoh data dari PHP (misalnya dari database atau variabel lainnya)
                        $rows = [
                        ...
                        <table class="w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-left">
                                    <th class="min-w-fit px-4 py-4 font-medium text-black xl:pl-11">
                                        Package
                                    </th>
                                    <th class="min-w-fit px-4 py-4 font-medium text-black">
                                        Expiration
                                    </th>
                                    <th class="min-w-fit px-4 py-4 font-medium text-black">
                                        Visible
                                        ...
                                        <td class="border-b border-gray-300 px-4 py-4 xl:pl-11">
                                            <div class="flex items-center space-x-6">
                                                <img src="<?php echo $row['image']; ?>"
                                                    class="h-auto rounded-sm mr-5 hidden sm:block" width="150px"
                                                    alt="Package Image">
                                                <div>
                                                    <h5 class="font-medium text-black"><?php echo $row['name']; ?></h5>
                                                    <p class="text-sm"><?php echo $row['price']; ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="border-b border-gray-300 px-4 py-4">
                                            <p class="text-black"><?php echo $row['expiration']; ?></p>
                                        </td>
                                        <td class="border-b border-gray-300 px-4 py-4">
                                            <span
                                                class="text-sm font-medium <?php echo $row['visible'] ? 'bg-green-400 text-green-700 px-3 py-1 rounded-full' : 'bg-red-400 text-red-700 px-3 py-1 rounded-full'; ?>">
                                                <?php echo $row['visible'] ? 'Yes' : 'No'; ?>
                                            </span>
                                        </td>
                                        <td class="border-b border-gray-300 px-4 py-4">
                                            <div class="md:flex md:items-center md:space-x-3 space-y-3 grid grid-cols-1">
                                                <button @click="editRow(row)" class="hover:text-primary">
                                                ...
                                                <button @click="deleteRow(row)" class="hover:text-primary">
                                                ...
                                                <button @click="setStatus(row)" class="hover:text-primary">
