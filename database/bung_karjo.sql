...
CREATE TABLE `transactions` (
  ...
  `status` enum('invoice','paid') NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transaction_details` (
  ...
  `name` varchar(100) NOT NULL,
  `price` double NOT NULL,
  `amount_of_people` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','manager','visitor') NOT NULL,
...
ALTER TABLE `images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `images_tour_package_id_foreign` (`tour_package_id`);
...
ALTER TABLE `services`
  ADD PRIMARY KEY (`id`),
  ADD KEY `services_tour_package_id_foreign` (`tour_package_id`);
...
ALTER TABLE `transaction_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transaction_details_tour_package_id_foreign` (`tour_package_id`),
...
ALTER TABLE `videos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `videos_tour_package_id_foreign` (`tour_package_id`);
